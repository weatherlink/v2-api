...
* How the weather station data is uploaded to the WeatherLink service: Is the data uploaded via a WeatherLink Live, an EnviroMonitor, a WeatherLinkIP, a Vantage Connect, or a WeatherLink Network Annual Subscription?
...
* The subscription level of your association with the weather station. Is it Basic, Pro or Pro+ access?
