...
<h4>DEPRECATED</h4>
<p>API Signature is no longer required as this is no longer the preferred way of authenticating with the WeatherLink v2 API. Please see the <a href="tutorial">Tutorial</a> and <a href="authentication">Authentication</a> pages for more information on the preferred authentication mechanism which involves passing the API secret as a header.</p>
</div>
