...
Higher rate limits can be granted for large scale WeatherLink customers. To request a rate limit increase please join our [WeatherLink Developers Discord](https://weatherlink.github.io/discord) and post a message in the WeatherLink v2 API chat channel explaining your situation.
